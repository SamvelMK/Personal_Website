    ...
    <div class="colorlib-narrow-content">
        ...
        <div
            ...
            <div class="col-md-12">
                <p class="work-menu">
                    <span>
                        <a href="{{ asset('projects/research.blade.php') }}"> Academic Research </a>
                    </span>
                    <span>
                        <a href="{{ asset('projects/datascience.blade.php') }}"> Data Science </a>
                    </span>
                    <span>
                        <a href="{{ asset('projects/usefulapp.blade.php') }}"> Useful Applications </a>
                    </span>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 animate-box">
                <p>
                    <a href="#" class="btn btn-primary btn-lg btn-load-more">Load more
